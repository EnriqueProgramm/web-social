...
const Menu = ({history}) => (
    <div>
        <ul className="nav nav-tab bg-primary">
            ...
            <li className="nav-item">
                <Link className="nav-link active" style={isActive(history, "/signup")} to="/signup">Signup</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link active" style={isActive(history, "/signin")} to="/signin">Signin</Link>
            </li>
        </ul>
    </div>
);
